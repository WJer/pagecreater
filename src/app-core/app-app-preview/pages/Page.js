...
class Page extends Component {
  ...
  render() {
    ...
    return (
      <div className={`app-swiper-layers-box ${isLangPage ? 'swiper-wrapper' : ''}`}>
        <div ref={c => (this.swiperPageRef = c)} className={`app-swiper-layers ${isLangPage ? 'swiper-slide' : ''}`} style={{ ...onPageStyle }}>
