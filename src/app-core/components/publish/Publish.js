  ...
  render() {
    ...
    return (
      <div className="app-publish">
        <a className="app-btn-min" onClick={this.saveApp}>
          {loading ? (
            <span>
            ...
            <span>
              <i className="app-ico app-ico-baocun" /> 保存
            </span>
          )}
        </a>
        &nbsp;&nbsp;
        <a onClick={this.modalShow} className="app-btn-min app-js-publish">
          <i className="app-ico app-ico-fabu" /> 预览/发布
        </a>
        <H5dsModal className="app-modal-source" forceRender={true} show={show} close={this.onClose}>
