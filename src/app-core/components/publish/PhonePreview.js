...
import H5dsSwiper from '../../app-app-preview/swiper';
  ...
  render() {
    ...
    return (
      <div className="app-phone-preview">
        <div className="app-phone-preview-box">
          <div className="app-phone-preview-content">
            <div className="app-phone-preview-view">
              <div className="app-phone-preview-header">
              ...
              <div id="app-phone-preview-bodyer" style={{ left }} className="app-phone-preview-bodyer" >
            ...
            <div className="app-phone-preview-info">
              <div className="app-phone-preview-wx clearfix">
                <div className="app-phone-preview-img" onClick={this.changeMainImg}>
                  <img src={data.img} alt="" />
                </div>
                <div className="app-phone-preview-title">
                  <Input onChange={this.changeName} value={data.name} />
                </div>
                <div className="app-phone-preview-desc">
                  <TextArea onChange={this.changeDesc} style={{ height: 118 }} value={data.desc} rows={4} />
                </div>
              </div>
              <div className="app-phone-preview-wx clearfix">
                <div className="app-phone-preview-img">
                  {this.state.url && (
                    <QRCode
                      {...{
              ...
              <div className="app-phone-preview-down">
                <Alert
