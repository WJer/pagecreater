...
export default class PageButton extends Component {
  ...
  render() {
    ...
    return (
      <div className="app-phone-preview-pagebutton">
        <a onClick={this.prevPage} className="app-phone-preview-prev">
          上一页
        </a>
        <span>
          {page + 1}/{pageLength}
        </span>
        <a onClick={this.nextPage} className="app-phone-preview-next">
          下一页
        </a>
      </div>
    );
