...
class AppSet extends Component {
  constructor(props) {
    ...
    this.appData = data;
    let { desc, name, loading = '', set = {}, type = 'pc', slider = {}, style = {} } = data;
    let {
      width,
      height,
      backgroundImageCrop = '{}',
  ...
  render() {
    ...
    this.appData.desc;
    return (
      <div className="app-appset">
        <Tabs size="small" defaultActiveKey="1" className="app-basic-tabs">
          <TabPane key="1" tab="分享">
            <AppMainImg />
            <SetItem className="app-appset-item" name="H5标题">
              <Input value={name} onChange={e => this.changeVal(e.target.value, 'name')} />
            </SetItem>
            <SetItem className="app-appset-item" name="H5描述">
          ...
          <TabPane key="3" tab="翻页">
            <div className="app-appset-slider">
              <SetItem name="翻页动画">
