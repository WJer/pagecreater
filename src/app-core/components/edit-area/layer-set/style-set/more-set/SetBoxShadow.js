...
class SetBoxShadow extends Component {
  ...
  componentDidMount() {
    $('.app-scroll-SetBoxShadow').on('mousewheel.h5ds.SetBoxShadow', e => {
      e.preventDefault();
  ...
  componentWillUnmount() {
    $('.app-scroll-SetBoxShadow').off('mousewheel.h5ds.SetBoxShadow');
  }
      ...
      <div>
        ...
        {bsize !== null ? (
          <React.Fragment>
            <SetItem name="阴影设置">
              <SliderGroup
                mouseWheelClassName="app-scroll-SetBoxShadow"
