...
class BasicSet extends Component {
  ...
  componentDidMount() {
    ...
    $(document).on('mousewheel.h5ds.basicSet', '.app-scroll-BasicSet', e => {
      e.stopPropagation();
      // e.preventDefault();
    ...
    return (
      <div className="app-baiscset">
          ...
          <SetGrid span={2}>
            <SetItem name="宽度">
              ...
              <i
                ...
                className={['app-chain-width-height app-ico app-ico-chain', this.layer.set.lockWideHigh ? 'app-chain-width-height-active' : ''].join(' ')}
              ></i>
            </SetItem>
          </SetGrid>
        )}
        ...
        {editorConfig.flip !== false && (
          <SetGrid>
            <SetItem className="app-layer-flip" name="翻转">
