...
class LayerSetAlign extends Component {
  ...
  render() {
    return (
      <ul>
        <li className="app-item" onClick={this.alignLeft}>
          <i className="app-ico app-ico-duiqi" /> <span>左对齐</span>
        </li>
        <li className="app-item" onClick={this.alignRight}>
          <i className="app-ico app-ico-duiqi_youduiqi" /> <span>右对齐</span>
        </li>
        <li className="app-item" onClick={this.alignTop}>
          <i className="app-ico app-ico-duiqi_xiangxia" /> <span>上对齐</span>
        </li>
        <li className="app-item" onClick={this.alignDown}>
          <i className="app-ico app-ico-duiqi_xiangshang" /> <span>下对齐</span>
        </li>
        <li className="app-item" onClick={this.horizontalCenter}>
          <i className="app-ico app-ico-duiqi_hengxiangjuzhong" /> <span>水平居中</span>
        </li>
        <li className="app-item" onClick={this.verticalCenter}>
          <i className="app-ico app-ico-duiqi_juzhong" /> <span>垂直居中</span>
        </li>
        <li className="app-item" onClick={this.verticalSplit}>
          <i className="app-ico app-ico-meun" /> <span>垂直均分</span>
        </li>
        <li className="app-item" onClick={this.horizontalSplit}>
          <i className="app-ico app-ico-caidan1" /> <span>水平均分</span>
        </li>
        <li className="app-item" onClick={this.randomDistrib}>
          <i className="app-ico app-ico-ttpodicon" /> <span>随机分布</span>
        </li>
        <li className="app-item" onClick={this.randomSize}>
          <i className="app-ico app-ico-fenbushinengyuan" /> <span>随机大小</span>
        </li>
      </ul>
    );
  }
