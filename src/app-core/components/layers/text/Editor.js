...
class Editor extends Component {
  ...
  dbclickEvent() {
    // 双击文本框，可编辑
    $('#h5dsCanvas').on('dblclick.texteditor', '.app-control', e => {
      // 变成编辑器
      ...
      this.editAuto.off('blur').on('blur', e => {
        ...
        transaction(() => {
          ...
          $('.app-ex-h5ds_text-richtext')[0] && $('.app-ex-h5ds_text-richtext').html(shtml);
  ...
  render() {
    ...
    return (
      <div className="app-ex-h5ds_text">
        <EditorSet
...
// 图标
const icon = <i className="app-ico app-ico-wenben" />;
