...
export class Artword extends PureComponent {
  ...
  render() {
    ...
    const cName = ['app-artword', 'app-artword-' + type];
    ...
    if (shtml) {
      ...
      return (
        <div style={style} className={cName.join(' ')}>
          <div style={upStyle} className="app-artword-up">
            {this.props.children}
          </div>
          <div style={downStyle} className="app-artword-down">
            {this.props.children}
          </div>
          {otherStyle ? (
            <div style={otherStyle} className="app-artword-up">
              {this.props.children}
            </div>
          ) : null}
        </div>
