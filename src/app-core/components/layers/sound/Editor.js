...
class Editor extends Component {
  ...
  render() {
    ...
    return (
      <div className="app-ex-h5ds_sound">
        <SetGrid span={2}>
          <SetItem name="音乐图标">
        ...
        <SetItem name="当前音乐">
          <span className="app-ex-h5ds_sound-name">{name}</span>
          <audio className="app-sound-controls" key={sound} controls>
...
const icon = <i className="app-ico app-ico-yinle" />;
