...
class AdsorbLine extends Component {
  ...
  componentDidMount() {
    window.pubSubEditor.subscribe('h5ds.control.absorb.start', () => {
      ...
      this.layersTarget = [...this.layersTarget, $('#h5dsCanvasApp')[0], ...$('.app-ruler-guides')];
