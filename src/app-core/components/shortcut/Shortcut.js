...
class Shortcut extends Component {
  ...
  @bindSelf
  setScale(type) {
    let style = $('.app-canvas-box').attr('style');
  ...
  async getPageImage() {
    ...
    return domtoimage.toPng(document.getElementById('h5dsCanvasApp'), {
      ...
      filter: node => {
        const exclass = ['app-grid-box app-js-grid', 'app-setpage-height', 'app-setpage-width', 'app-control'];
        ...
        <div style={{ display: this.state.show ? 'block' : 'none' }}>
          <div>
            <ul>
              ...
              >
                <a>
                  <i className="app-ico app-ico-bofang" />
                </a>
                <span>播放动画</span>
              </li>
              ...
              <li onClick={this.saveToImage}>
                <a>
                  <i className="app-ico app-ico-beijing" />
                </a>
                <span>存为图片</span>
              </li>
              <li>
              ...
              <li className="app-js-savepage" onClick={this.savePage}>
                <a>
          ...
          <div className="app-shortcut-bottom-btns">
            <ul>
              <li onClick={this.undo}>
                <a>
                  <i className="app-ico app-ico-chexiao2" />
                </a>
                <span>撤销</span>
              </li>
              <li onClick={this.redo}>
                <a>
                  <i className="app-ico app-ico-chexiao1" />
                </a>
                <span>前进</span>
              </li>
              <li onClick={() => this.setScale('add')}>
                <a>
                  <i className="app-ico app-ico-fangda" />
                </a>
                <span>放大画布</span>
              </li>
              <li onClick={() => this.setScale('del')}>
                <a>
                  <i className="app-ico app-ico-suoxiao" />
                </a>
                <span>缩小画布</span>
              </li>
              <li>
              ...
              <li onClick={this.addPage}>
                <a className="app-shortcut-add">
                  <i className="app-ico app-ico-jia1" />
                </a>
                <span>添加页面</span>
              </li>
              <li>
