...
class ContextMenu extends Component {
  ...
  mouseright() {
    ...
    $(document)
      ...
      .on('contextmenu.menu', '.app-canvas-app > div > .app-swiper-layers > .layer, .app-contextmenu, #h5dsCanvasApp', e => {
        e.preventDefault();
        e.stopPropagation();
        // 如果单纯的选择 layer
        ...
        switch (targetType) {
          case 'layer':
            vals = [
              { name: '<i class="app-ico app-ico-dingceng"></i> 置顶', val: 'top' },
              { name: '<i class="app-ico app-ico-diceng"></i> 置底', val: 'bottom' },
              { name: '<i class="app-ico app-ico-shangyiyiceng"></i> 上移一层', val: 'prev' },
              { name: '<i class="app-ico app-ico-xiayiyiceng"></i> 下移一层', val: 'next' },
              { name: '<i class="app-ico app-ico-fuzhi"></i> 复制图层', val: 'copy' },
              { name: '<i class="app-ico app-ico-niantie"></i> 粘贴图层', val: 'paste' },
              { name: '<i class="app-ico app-ico-fuzhi"></i> 复制动画', val: 'copyAnimate' },
              { name: '<i class="app-ico app-ico-niantie"></i> 粘贴动画', val: 'pasteAnimate' },
              { name: '<i class="app-ico app-ico-icodel"></i> 删除图层', val: 'del' },
              { name: '<i class="app-ico app-ico-baocun"></i> 保存图层', val: 'save' }
            ];
            if ($layer.hasClass('layer-h5ds_combin')) {
              vals.push({ name: '<i class="app-ico app-ico-fuzhi"></i> 取消合并', val: 'uncombin' });
            }
            break;
          case 'group':
            vals = [
              { name: '<i class="app-ico app-ico-fuzhi"></i> 合并图层', val: 'combin' },
              { name: '<i class="app-ico app-ico-fuzhi"></i> 复制图层', val: 'copy' },
              { name: '<i class="app-ico app-ico-niantie"></i> 粘贴图层', val: 'paste' },
              { name: '<i class="app-ico app-ico-icodel"></i> 删除图层', val: 'del' }
            ];
            break;
          case 'null':
            vals = [{ name: '<i class="app-ico app-ico-niantie"></i> 粘贴图层', val: 'paste' }];
            break;
        }
