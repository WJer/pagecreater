...
class Navigator extends Component {
  ...
  onMouseDown(e) {
    ...
    const $realSizeCanvas = $('.app-canvas-realsize');
  ...
  componentDidMount() {
    // 缩放大小
    $('.app-canvas-navigator').on('mousewheel.h5ds.navigator', e => {
      e.stopPropagation();
      // 缩放图形
  ...
  componentWillUnmount() {
    $('.app-canvas-navigator').off('mousewheel.h5ds.navigator');
  ...
  render() {
    ...
    return (
      <div className="app-canvas-navigator-box" style={{ ...bstyle }}>
        <div className="app-canvas-navigator" style={{ ...bstyle }}>
          <div className="app-canvas-navigator-control" onMouseDown={this.onMouseDown} style={{ ...controlStyle }} />
          <div className="app-canvas-navigator-page" style={{ ...pageStyle }} />
        </div>
        <a
          style={{ transform: `rotate(${open ? -180 : 0}deg)` }}
          onClick={this.changeNavigatorWindow}
          className="app-canvas-navigator-btn"
        >
          <i className="app-ico app-ico-shouqi" />
        </a>
      </div>
    );
  }
