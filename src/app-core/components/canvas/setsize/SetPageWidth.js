...
class SetPageWidth extends Component {
  ...
  setPageWidth(e) {
    ...
    const $pageWidthNum = $('.app-js-setpage-width');
  ...
  render() {
    ...
    return (
      <div className="app-setpage-width">
        <span key={width} className="app-setpage-px app-js-setpage-width">
          {width}
          px
        </span>
        <a ref={c => (this.btn = c)} className="app-js-setpage app-setpage-width-btn">
